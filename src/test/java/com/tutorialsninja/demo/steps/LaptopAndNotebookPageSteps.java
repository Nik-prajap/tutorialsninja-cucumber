...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Nikhil");
        new CheckoutPage().enterLastName("Prajapati");
        new CheckoutPage().enterEmailId("primetesting");
        new CheckoutPage().enterTelephone("07999999990");
        new CheckoutPage().enterAddressLine1("57 Elmgrove Road");
        new CheckoutPage().enterCity("Harrow");
        new CheckoutPage().enterPostCode("HA12QD");
